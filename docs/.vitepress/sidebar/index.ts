  ...
  '/notes/': [
    {
      ...
      collapsed: true,
      items: [
        { text: '初识 HTML', link: `/notes/01_basic/01_${commonDirectoryName}/` },
        { text: 'HTML 基础', link: `/notes/01_basic/02_${commonDirectoryName}/` },
        { text: '额外知识', link: `/notes/01_basic/03_${commonDirectoryName}/` },
        { text: 'CSS 基础', link: `/notes/01_basic/04_${commonDirectoryName}/` },
        { text: 'CSS 进阶', link: `/notes/01_basic/05_${commonDirectoryName}/` },
        { text: 'CSS 特性', link: `/notes/01_basic/06_${commonDirectoryName}/` },
        { text: 'CSS 盒子模型', link: `/notes/01_basic/07_${commonDirectoryName}/` },
        { text: '额外知识', link: `/notes/01_basic/08_${commonDirectoryName}/` },
        { text: 'CSS 浮动', link: `/notes/01_basic/09_${commonDirectoryName}/` },
      ]
    },
    {
      text: 'JavaScript基础',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        { text: '初识 TypeScript', link: `/notes/07_TypeScript/01_${commonDirectoryName}/` },
        { text: 'TypeScript 语法细节', link: `/notes/07_TypeScript/02_${commonDirectoryName}/` },
        { text: 'TypeScript 面向对象', link: `/notes/07_TypeScript/03_${commonDirectoryName}/` },
        { text: 'TypeScript 泛型编程', link: `/notes/07_TypeScript/04_${commonDirectoryName}/` },
        { text: 'TypeScript 语法扩展', link: `/notes/07_TypeScript/05_${commonDirectoryName}/` },
      ]
    },
    {
      text: 'React18全家桶',
      collapsed: true,
      items: [
        { text: '初识 React', link: `/notes/08_React18/01_${commonDirectoryName}/` },
        { text: 'React 脚手架', link: `/notes/08_React18/02_${commonDirectoryName}/` },
        { text: 'React 组件化开发（一）', link: `/notes/08_React18/03_${commonDirectoryName}/` },
        { text: 'React 组件化开发（二）', link: `/notes/08_React18/04_${commonDirectoryName}/` },
        { text: 'React 组件化开发（三）', link: `/notes/08_React18/05_${commonDirectoryName}/` },
        { text: 'React 组件化开发（四）', link: `/notes/08_React18/06_${commonDirectoryName}/` },
        { text: 'React 的 CSS 解决方案', link: `/notes/08_React18/07_${commonDirectoryName}/` },
        { text: 'React 状态管理（redux）', link: `/notes/08_React18/08_${commonDirectoryName}/` },
        { text: 'React 状态管理二（redux）', link: `/notes/08_React18/09_${commonDirectoryName}/` },
        { text: 'React 路由', link: `/notes/08_React18/10_${commonDirectoryName}/` },
        { text: 'React Hooks（一）', link: `/notes/08_React18/11_${commonDirectoryName}/` },
        { text: 'React Hooks（二）', link: `/notes/08_React18/12_${commonDirectoryName}/` },
      ]
    }
  ],
}
